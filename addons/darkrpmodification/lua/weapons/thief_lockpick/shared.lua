...
SWEP.PrintName = "Thief Lock Pick"
SWEP.Author = "DarkRP Developers"
SWEP.Instructions = "Left or right click to pick a lock"
SWEP.Contact = ""
SWEP.Purpose = ""
SWEP.IsDarkRPLockpick = false
...
function SWEP:PrimaryAttack()
    self:SetNextPrimaryFire(CurTime() + 0.5) --maybe needs to be 2?
    ...
    self:SetLockpickEndTime(CurTime() + endDelta / 1.5) --this is what makes it go faster, the divison
...
--[[ -- disabled because thief lockpick makes no sound
