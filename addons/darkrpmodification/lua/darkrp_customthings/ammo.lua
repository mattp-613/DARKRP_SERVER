...
-- black market dealer ammo

GAMEMODE:AddAmmoType("xbowbolt", "Crossbow bolts", "models/Items/crossbowrounds.mdl", 100, 2, function( ply ) return ply:Team() == TEAM_BLACK end)

GAMEMODE:AddAmmoType("slam", "S.L.A.M", "models/weapons/w_slam.mdl", 250, 1, function( ply ) return ply:Team() == TEAM_BLACK end)

GAMEMODE:AddAmmoType("rpg_round", "RPG rounds", "models/dynamite/dynamite.mdl", 100, 1, function( ply ) return ply:Team() == TEAM_BLACK end)
...
GAMEMODE:AddAmmoType("smg1_grenade", "SMG Grenades", "models/items/ar2_grenade.mdl", 100, 1, function( ply ) return ply:Team() == TEAM_GUN end)
